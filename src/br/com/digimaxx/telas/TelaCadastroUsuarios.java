...
public class TelaCadastroUsuarios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtSenha.setPreferredSize(new java.awt.Dimension(199, 35));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        }else if(usuAtivo == null){
            JOptionPane.showMessageDialog(null, "Identifique se o Usuário está Ativo ou Inativo");
        }else{
