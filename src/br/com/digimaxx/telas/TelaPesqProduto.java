   ...
   Cliente clientes = new Cliente();
    ...
    private void pesquisaCodigoBarras(){                
     ...
     private void setar(){
        ...
        TelaVendas.txtCodProduto.setText(tblProdutos.getModel().getValueAt(setar, 0).toString());
        TelaVendas.txtQtd.setText("1");
        TelaVendas.txtQtd.selectAll();
        TelaVendas.txtQtd.requestFocus();
        dispose();
     }
